...
public class kostenlwReport
    extends SimplePrint

{

  public kostenlwReport() {
  }
...

  {
    ...
    i = zaehlen(i, 90);
    g.drawString(startframe.Texte.elementAt(214).toString(), 80, i);
    g.setFont(fnt6);
    ...
    i = zaehlen(i, 12);
    g.drawString(startframe.Texte.elementAt(215).toString(), 100, i);
    ...
    g.drawString(Integer.toString( (int) (betrkosten.salzSaeureKost +
                                          ...
                                          betrkosten.enKost + betrkosten.roKost +
                                          anlageKostenJahr)) + " EUR/Jahr", 300,
                 i);
