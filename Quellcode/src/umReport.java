...

{
...

  {
    ...
    i = zaehlen(i, 150);
    g.drawString(startframe.Texte.elementAt(257).toString(), 80, i);
    g.setFont(fnt2);
    ...
    g.drawString(zahltostring(analyse.tW, 4) + " °C", 300, i);
    i = zaehlen(i, 15);
    ...
    g.drawString(zahltostring(analyse.pHggWW, 4), 300, i);
    i = zaehlen(i, 15);
    g.drawString(startframe.Texte.elementAt(211).toString(), 100, i);
    g.drawString(zahltostring(analyse.sIW, 5), 300, i);
